...
window.addEventListener("DOMContentLoaded", function () {
    !function (a, b) {
        "object" == typeof exports && "object" == typeof module ? module.exports = b() : "function" == typeof define && define.amd ? define([], b) : "object" == typeof exports ? exports.GDemo = b() : a.GDemo = b()
        ...
        return function (a) {
            ...
            var c = {};
            c.parseHtml = function (a) {
                return new DOMParser().parseFromString(a, "text/html").querySelector("body").firstChild
            }, c.wrapHtmlStringInHtmlTag = function (a, b) {
                return "<" + b + ">" + a + "</" + b + ">"
            }, c.clearNodeContent = function (a) {
                return a.innerHTML = "", a
            }, c.containsClosingHtmlTag = function (a) {
                return /<\/.+>/gm.test(a)
            }, c.isHtmlNodeTypeText = function (a) {
                return a && "#text" == a.nodeName.toLowerCase()
            }, b.default = c, a.exports = b.default
        }, function (a, b) {
            'use strict';
            Object.defineProperty(b, "__esModule", {value: !0});
            var c = {};
            c.toKebabCase = function (a) {
                return a.toLowerCase().replace(" ", "-")
            }, c.isEmptyString = function (a) {
                return "" === a.trim()
            }, c.removeBlankFirstLine = function (a) {
                var b = a.split("\n");
                return "" === b[0].trim() && b.splice(0, 1), b
            }, b.default = c, a.exports = b.default
        }, function (b, e, g) {
            'use strict';
            ...
            function k(a) {
                var b = n(a);
                return b.appendChild(f.default.parseHtml(r.default)), b
            }

            function n(a) {
                var b = document.createElement("div"), c = d.default.toKebabCase(a) + "-application";
                return b.setAttribute("class", c), b
            }

            function a(a) {
                return a.querySelector("[data-content-container]")
            }

            function o(a) {
                return a.querySelector("[data-title-container]")
            }

            function l(a, b) {
                a.querySelector("[data-application]").classList[b]("application-maximized")
            }

            Object.defineProperty(e, "__esModule", {value: !0}), e.Application = void 0;
            var c = function () {
                function a(a, b) {
            ...
            g(14);
            var q = g(0), f = j(q), p = g(1), d = j(p), m = g(15), r = j(m);
            e.Application = function () {
                function b(a) {
                    var c = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : {};
                    i(this, b), this.type = a, this.options = c, this.element = k(a), this.setOptions(this.options)
                }

                return c(b, [{
                    key: "setOptions", value: function (a) {
                        a.minHeight && this.setMinHeight(a.minHeight), a.windowTitle && this.setWindowTitle(a.windowTitle)
                    }
                }, {
                    key: "setMinHeight", value: function (b) {
                        var c = a(this.element), d = parseInt(b) - 26;
                        c.style.minHeight = d + "px"
                    }
                }, {
                    key: "setWindowTitle", value: function (a) {
                        o(this.element).innerText = a, this.windowTitle = a
                    }
                }, {
                    key: "addContent", value: function (b) {
                        a(this.element).appendChild(b)
                    }
                }, {
                    key: "minimize", value: function () {
                        this.setMaximized(!1), l(this.element, "remove")
                    }
                }, {
                    key: "maximize", value: function () {
                        this.setMaximized(!0), l(this.element, "add")
                    }
                }, {
                    key: "setMaximized", value: function (a) {
                        this.isMaximized = a
                    }
                }]), b
            }()
            ...
            Object.defineProperty(d, "__esModule", {value: !0}), d.Cursor = void 0;
            var j = function () {
                function a(a, b) {
                    for (var c, d = 0; d < b.length; d++) c = b[d], c.enumerable = c.enumerable || !1, c.configurable = !0, "value" in c && (c.writable = !0), Object.defineProperty(a, c.key, c)
                }
            ...
            e(18);
            var a = e(0), k = g(a), l = e(19), c = g(l), m = e(21), f = g(m);
            d.Cursor = function () {
                function a() {
                    h(this, a), this.element = k.default.parseHtml(f.default)
                }

                return j(a, [{
                    key: "write", value: function (a, b) {
                        c.default.type(this.element, a, b)
                    }
                }, {
                    key: "setActive", value: function () {
                        i(this.element, "add", "cursor-active")
                    }
                }, {
                    key: "setInactive", value: function () {
                        i(this.element, "remove", "cursor-active")
                    }
                }]), a
            }()
        }, function (a, b) {
            ...
            function c(a, b, c, e) {
                a.append(b), setTimeout(function () {
                    d.type(a, c.join(""), e)
                }, 75)
            }
            ...
            Object.defineProperty(b, "__esModule", {value: !0});
            var d = {};
            d.type = function (a, b, d) {
                var e = b.split(""), f = e.shift();
                f ? c(a, f, e, d) : d()
            ...
            Object.defineProperty(d, "__esModule", {value: !0}), d.TerminalLine = void 0;
            var h = function () {
                function a(a, b) {
                    for (var c, d = 0; d < b.length; d++) c = b[d], c.enumerable = c.enumerable || !1, c.configurable = !0, "value" in c && (c.writable = !0), Object.defineProperty(a, c.key, c)
                }
            ...
            e(26);
            var i = e(0), a = f(i), j = e(27), k = f(j);
            d.TerminalLine = function () {
                function b() {
                    g(this, b), this.element = a.default.parseHtml(k.default)
                }

                return h(b, [{
                    key: "setContent", value: function (a) {
            ...
            d(7), d(8);
            var e = d(9), h = function () {
                function a(b) {
                    f(this, a), this.container = document.querySelector(b), this.steps = []
                }

                return g(a, [{
                    key: "openApp", value: function (a) {
                        var b = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : {};
                        return this.steps.push({app: a, options: b, onCompleteDelay: b.onCompleteDelay}), this
                    }
                }, {
                    key: "write", value: function (a) {
                        ...
                        return this.steps.push({
                            ...
                            action: "write",
                            params: {codeSample: a},
                            onCompleteDelay: b.onCompleteDelay
                        }), this
                    }
                }, {
                    key: "command", value: function (a) {
                        var b = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : {};
                        return this.steps.push({
                            app: "terminal",
                            action: "command",
                            params: {command: a, promptString: b.promptString},
                            onCompleteDelay: b.onCompleteDelay
                        }), this
                    }
                }, {
                    key: "respond", value: function (a) {
                        var b = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : {};
                        return this.steps.push({
                            app: "terminal",
                            action: "respond",
                    ...
                    key: "end", value: function () {
                        return new e.Player(this.container, this.steps).play()
                    }
                }]), a
            }();
            ...
            function g(b, c, d, e) {
                var f = b.getCurrentStepNumber();
                if (f < d.length) {
                    var a = d[f];
                    h(c, a, function () {
                        b.setCurrentStepNumber(f + 1), g(b, c, d, e)
                    }, a.onCompleteDelay)
                } else e()
            }
            ...
            function h(a, b, c) {
                ...
                j(a, b.app, b.options, function (a) {
                    b.action ? a[b.action](b.params, function () {
                        setTimeout(c, d)
                    }) : setTimeout(c, d)
                })
            }
            ...
            function j(a, b, c, d) {
                var e = a.openApplication(b, c);
                e.isMaximized ? d(e) : a.minimizeAllApplications(function () {
                    a.maximizeApplication(e, function () {
                        d(e)
                    })
                })
            }

            Object.defineProperty(c, "__esModule", {value: !0}), c.Player = void 0;
            var a = function () {
                function a(a, b) {
                    for (var c, d = 0; d < b.length; d++) c = b[d], c.enumerable = c.enumerable || !1, c.configurable = !0, "value" in c && (c.writable = !0), Object.defineProperty(a, c.key, c)
                }
            ...
            c.Player = function () {
                function b(a, c) {
                    f(this, b), this.container = a, this.steps = c, this.desktop = new i.Desktop(a), this.setCurrentStepNumber(0)
                }
                ...
                return a(b, [{
                    key: "play", value: function () {
                        ...
                        return new Promise(function (b) {
                            g(a, a.desktop, a.steps, function () {
                                b()
                            })
                        })
                    }
                }, {
                    key: "getCurrentStepNumber", value: function () {
                        return this.currentStepNumber
                    }
                }, {
                    key: "setCurrentStepNumber", value: function (a) {
            ...
            function j(a, b, c) {
                var d = "editor" == b ? m.EditorApplication : l.TerminalApplication, e = new d(a.element, c);
                return a.openApplications.push(e), a.element.appendChild(e.element), e
            }

            function k(a, b) {
                for (var c, d = 0; d < a.length; d++) if (c = a[d], c.type == b) return c
            }

            Object.defineProperty(e, "__esModule", {value: !0}), e.Desktop = void 0;
            var a = function () {
                function a(a, b) {
                    for (var c, d = 0; d < b.length; d++) c = b[d], c.enumerable = c.enumerable || !1, c.configurable = !0, "value" in c && (c.writable = !0), Object.defineProperty(a, c.key, c)
                }
            ...
            e.Desktop = function () {
                ...
                return a(b, [{
                    key: "openApplication", value: function (a, b) {
                        var c = k(this.openApplications, a);
                        return c || j(this, a, b)
                    }
                }, {
                    key: "minimizeAllApplications", value: function (a) {
                        for (var b = 0; b < this.openApplications.length; b++) this.openApplications[b].minimize();
                        setTimeout(a, 0)
                    }
                }, {
                    key: "maximizeApplication", value: function (a, b) {
                        a.maximize(), setTimeout(b, 0)
                    }
                }]), b
            }()
        }, function () {
            ...
            function k(a) {
                return a.windowTitle || "~/demo/demo.js"
            }

            function a(b, c, d) {
                var e = c.shift();
                void 0 === e ? d() : (o(b.lines), l(b, e, function () {
                    a(b, c, d)
                }))
            }

            function o(a) {
                a.length && a[a.length - 1].setInactive()
            }

            function l(a, b, c) {
                var d = new f.EditorLine(a.lines.length + 1);
                a.addContent(d.element), a.lines.push(d), d.setActive(), d.write(b, c)
            }

            Object.defineProperty(e, "__esModule", {value: !0}), e.EditorApplication = void 0;
            var c = function () {
                function a(a, b) {
                    for (var c, d = 0; d < b.length; d++) c = b[d], c.enumerable = c.enumerable || !1, c.configurable = !0, "value" in c && (c.writable = !0), Object.defineProperty(a, c.key, c)
                }
            ...
            g(13);
            var n = g(2), f = g(16), p = g(1), d = function (a) {
                return a && a.__esModule ? a : {default: a}
            }(p);
            e.EditorApplication = function (b) {
                function f(a) {
                    var b = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : {};
                    h(this, f);
                    var c = i(this, (f.__proto__ || Object.getPrototypeOf(f)).call(this, "editor", b));
                    return c.container = a, c.container.appendChild(c.element), c.lines = [], c.setWindowTitle(k(b)), c
                }

                return j(f, b), c(f, [{
                    key: "write", value: function (b, c) {
                        var e = b.codeSample;
                        a(this, d.default.removeBlankFirstLine(e), c)
                    }
                }]), f
            }(n.Application)
        }, function () {
            ...
            function k(a) {
                return n(a, "[data-editor-line-number]")
            }

            function a(a) {
                return n(a, "[data-editor-line-text]")
            }
            ...
            Object.defineProperty(e, "__esModule", {value: !0}), e.EditorLine = void 0;
            var l = function () {
                function a(a, b) {
                    for (var c, d = 0; d < b.length; d++) c = b[d], c.enumerable = c.enumerable || !1, c.configurable = !0, "value" in c && (c.writable = !0), Object.defineProperty(a, c.key, c)
                }
            ...
            g(17);
            var c = g(3), o = g(0), f = h(o), p = g(22), d = h(p);
            e.EditorLine = function () {
                function b(e) {
                    i(this, b), this.cursor = new c.Cursor, this.element = f.default.parseHtml(d.default), a(this.element).appendChild(this.cursor.element), j(this.element, e)
                }

                return l(b, [{
                    key: "write", value: function (a, b) {
                        this.cursor.write(a, b)
                    }
                }, {
                    key: "setActive", value: function () {
            ...
            function i(b) {
                return a.default.containsClosingHtmlTag(b) ? m.default : l.default
            }

            Object.defineProperty(d, "__esModule", {value: !0});
            var j = e(0), a = g(j), k = e(4), l = g(k), c = e(20), m = g(c), f = {};
            f.type = function (a, b, c) {
                h(a, "add", "is-typing"), i(b).type(a, b, function () {
                    h(a, "remove", "is-typing"), c()
                })
            ...
            function i(a) {
                var b = c.default.wrapHtmlStringInHtmlTag(a, "span"), d = c.default.parseHtml(b);
                return Array.from(d.childNodes)
            }

            function j(a, b, c) {
                return b.length ? void k(a, b.shift(), function () {
                    j(a, b, c)
                }) : c()
            }

            function k(b, d, e) {
                c.default.isHtmlNodeTypeText(d) ? m(d.textContent, b, e) : m(d.textContent, a(b, d), e)
            }

            function a(a, b) {
                var d = c.default.clearNodeContent(b);
                return a.appendChild(d), d
            }

            function m(a, b, c) {
                f.default.type(b, a, c)
            }

            Object.defineProperty(e, "__esModule", {value: !0});
            var l = g(0), c = h(l), n = g(4), f = h(n), o = {};
            o.type = function (a, b, c) {
                j(a, i(b), c)
            }, e.default = o, b.exports = e.default
        }, function (a) {
            a.exports = "<span class=\"cursor\"></span>\n"
        }, function (a) {
            a.exports = "<div class=\"editor-line\">\n  <div class=\"editor-line-number\" data-editor-line-number></div>\n  <pre class=\"editor-line-text\" data-editor-line-text></pre>\n</div>\n"
        }, function (b, e, g) {
            'use strict';
            ...
            function n(a) {
                return a.windowTitle || "bash"
            }

            function a(a) {
                return a.promptString || "~/demo $"
            }
            ...
            function l(a, b, c) {
                var d = new m.TerminalCommandLine(a.promptString);
                a.commandLines.push(d), a.addContent(d.element), d.setActive(), d.command(b, c)
            }

            function c(a) {
                var b = new r.TerminalResponseLine;
                return b.setText(a), b.element
            }

            Object.defineProperty(e, "__esModule", {value: !0}), e.TerminalApplication = void 0;
            var q = function () {
                function a(a, b) {
                    for (var c, d = 0; d < b.length; d++) c = b[d], c.enumerable = c.enumerable || !1, c.configurable = !0, "value" in c && (c.writable = !0), Object.defineProperty(a, c.key, c)
                }
                ...
                return a && a.__esModule ? a : {default: a}
            }(f), d = g(2), m = g(24), r = g(29), h = function (b) {
                function d(a) {
                    var b = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : {};
                    j(this, d);
                    var c = i(this, (d.__proto__ || Object.getPrototypeOf(d)).call(this, "terminal", b));
                    return c.container = a, c.container.appendChild(c.element), c.setCommandLines([]), c.configOptions(b), c
                }

                return k(d, b), q(d, [{
                    key: "configOptions", value: function (b) {
                        this.setWindowTitle(n(b)), this.setPromptString(a(b))
                    }
                }, {
                    key: "setCommandLines", value: function (a) {
                        this.commandLines = a
                    }
                }, {
                    key: "setPromptString", value: function (a) {
                        this.promptString = a
                    }
                }, {
                    key: "command", value: function (a, b) {
                        var c = a.command, d = a.promptString;
                        d && this.setPromptString(d), o(this.commandLines), l(this, c, b)
                    }
                }, {
                    key: "respond", value: function (a, b) {
                        for (var d = a.response, e = p.default.removeBlankFirstLine(d), f = 0; f < e.length; f++) this.addContent(c(e[f]));
                        b()
                    }
                }]), d
            }(d.Application);
            e.TerminalApplication = h
        }, function (b, e, g) {
            'use strict';
            ...
            function a(a) {
                return a.querySelector("[data-terminal-command-line-text]")
            }

            Object.defineProperty(e, "__esModule", {value: !0}), e.TerminalCommandLine = void 0;
            var n = function () {
                function a(a, b) {
                    for (var c, d = 0; d < b.length; d++) c = b[d], c.enumerable = c.enumerable || !1, c.configurable = !0, "value" in c && (c.writable = !0), Object.defineProperty(a, c.key, c)
                }
            ...
            g(25);
            var l = g(3), c = g(5), o = g(0), f = h(o), p = g(28), d = h(p);
            e.TerminalCommandLine = function (b) {
                function c(b) {
                    i(this, c);
                    var e = j(this, (c.__proto__ || Object.getPrototypeOf(c)).call(this));
                    return e.cursor = new l.Cursor, e.setContent(f.default.parseHtml(d.default)), e.setPromptString(b), a(e.element).appendChild(e.cursor.element), e
                }

                return k(c, b), n(c, [{
                    key: "setPromptString", value: function (a) {
                        this.element.querySelector("[data-terminal-command-line-prompt-string]").appendChild(f.default.parseHtml(a))
                    }
                }, {
                    key: "command", value: function (a, b) {
                        this.cursor.write(a, b)
            ...
            a.exports = "<div class=\"terminal-line\"></div>\n"
        }, function (a) {
            ...
            function a(a, b) {
                l(a, "terminal-response-line-html-text"), a.appendChild(b)
            }

            function n(a, b) {
                l(a, "terminal-response-line-plain-text"), a.innerText = b
            }
            ...
            Object.defineProperty(e, "__esModule", {value: !0}), e.TerminalResponseLine = void 0;
            var c = function () {
                function a(a, b) {
                    for (var c, d = 0; d < b.length; d++) c = b[d], c.enumerable = c.enumerable || !1, c.configurable = !0, "value" in c && (c.writable = !0), Object.defineProperty(a, c.key, c)
                }
            ...
            g(30);
            var o = g(5), f = g(0), p = h(f), d = g(31), m = h(d);
            e.TerminalResponseLine = function (b) {
                function d() {
                    i(this, d);
                    var a = j(this, (d.__proto__ || Object.getPrototypeOf(d)).call(this));
                    return a.setContent(p.default.parseHtml(m.default)), a
                }

                return k(d, b), c(d, [{
                    key: "setText", value: function (b) {
                        var c = this.element.querySelector("[data-terminal-response-line-text]");
                        return p.default.containsClosingHtmlTag(b) ? a(c, p.default.parseHtml(b)) : n(c, b)
                    }
                }]), d
            }(o.TerminalLine)
        }, function () {
        }, function (a) {
            a.exports = "<div class=\"terminal-response-line-text\" data-terminal-response-line-text></div>\n"
        }, function (a) {
            a.exports = "<div class=\"desktop\"></div>\n"
        }])
    })
});
...
window.addEventListener('DOMContentLoaded', function () {
    ...
    // load APIKey in first coding box
    if ($('#code_box').length)
        $('#code_box').html($('#code_box').html().replace('YOURAPIKEY', apiKey));
...
$(function () {
    $(window).on("scroll", function () {
        if ($(window).scrollTop() > 50) {
            $("#Hdr_main").addClass("active-nav");
        } else {
            $("#Hdr_main").removeClass("active-nav");
        }
    });
    ...
    $('.change-mode a').click(function (e) {
        e.preventDefault();
        mode = $(this).data('mode');
        ...
        $('.home-section-menu a:eq(0)').click();
    });
    ...
    $('.change-language button').click(function (e) {
        ...
        $('.change-language li').removeClass('active');
        $(this).parent().addClass('active');
        $('#code_box').removeAttr('class');
        $('#code_box').addClass('language-' + language);

        $('.home-section-menu a:eq(0)').click();
    });

    $('.home-section-menu a').click(function (e) {
        e.preventDefault();

        var id = $(this).data('code');
        $('.home-section-menu > li').removeClass('active');
        $(this).parent().addClass('active');

        if (language == 'bash')
            $('#code_box').html(`${curl[mode+'_'+id].replace(/YOURAPIKEY/g, apiKey)}`);
        if (language == 'java')
            $('#code_box').html(`${java[mode+'_'+id].replace(/YOURAPIKEY/g, apiKey)}`);
        if (language == 'javascript' || language == 'node')
            $('#code_box').html(`${node[mode+'_'+id].replace(/YOURAPIKEY/g, apiKey)}`);
        if (language == 'php')
            $('#code_box').html(`${php[mode+'_'+id].replace(/YOURAPIKEY/g, apiKey)}`);
        if (language == 'python')
            $('#code_box').html(`${python[mode+'_'+id].replace(/YOURAPIKEY/g, apiKey)}`);
        if (language == 'ruby')
            $('#code_box').html(`${ruby[mode+'_'+id].replace(/YOURAPIKEY/g, apiKey)}`);
    ...
    $('.doc-change-code').click(function (e) {
        e.preventDefault();
        ...
        var code_id = id.split('_')[2];
        language = id.split('_')[1];

        if (language == 'bash')
            $('#' + id).html(`${curl[mode+'_'+code_id].replace(/YOURAPIKEY/g, apiKey)}`);
        if (language == 'java')
            $('#' + id).html(`${java[mode+'_'+code_id].replace(/YOURAPIKEY/g, apiKey)}`);
        if (language == 'javascript' || language == 'node')
            $('#' + id).html(`${node[mode+'_'+code_id].replace(/YOURAPIKEY/g, apiKey)}`);
        if (language == 'php')
            $('#' + id).html(`${php[mode+'_'+code_id].replace(/YOURAPIKEY/g, apiKey)}`);
        if (language == 'python')
            $('#' + id).html(`${python[mode+'_'+code_id].replace(/YOURAPIKEY/g, apiKey)}`);
        if (language == 'ruby')
            $('#' + id).html(`${ruby[mode+'_'+code_id].replace(/YOURAPIKEY/g, apiKey)}`);
    ...
    $('#nav-tab .nav-link').click(function (e) {
        ...
        $('.scroll-down').each(function (i, v) {
            var newID = $(v).data('scrollto').split('-');
            $($(v).data('scrollto', id + '-' + newID[1]));
        });
    });
    ...
    <html lang="en">
      <head>
        <meta charset="utf-8">
          ...
        `)
        .command('<a href="/documentation" style="color: #fff; text-decoration: underline;">Click here to see full documentation...</a>')
        .end();
    const demo2 = new GDemo('#container2');
    demo2
        .openApp('terminal', {
            minHeight: '350px',
            promptString: '$'
...
// Listen for Inputs on Bandwidth Tab
    ...
    document.querySelector('.bandwidth-input #jsRendering').onclick = () => calBandwidth();
    document.querySelector('.bandwidth-input #geotargeting').onclick = () => calBandwidth();
    document.querySelector('.bandwidth-input #residentialIPs').onclick = () => calBandwidth();
    document.querySelector('.bandwidth-input #cookies').onclick = () => calBandwidth();
    document.querySelector('.bandwidth-input #sessions').onclick = () => calBandwidth();
    document.querySelector('.bandwidth-input #browserProfiles').onclick = () => calBandwidth();
...
function calBandwidth(){
    ...
    /// Check if checkboxes are checked or not - returns true or false
    jsRendering = document.querySelector('.bandwidth-input #jsRendering').checked;  
    residential = document.querySelector('.bandwidth-input #residentialIPs').checked;  
    geotargeting = document.querySelector('.bandwidth-input #geotargeting').checked;
    cookies = document.querySelector('.bandwidth-input #cookies').checked;
    sessions = document.querySelector('.bandwidth-input #sessions').checked;
    browserProfiles = document.querySelector('.bandwidth-input #browserProfiles').checked;
